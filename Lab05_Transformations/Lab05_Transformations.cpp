...
int main( void )
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //glm::mat4 translate = Maths::translate(glm::vec3(0.0f, 0.3f, 0.0f));
        ...
        glm::mat4 scale = Maths::scale(glm::vec3(0.4f/2, 0.3f/2, 0.0f/2));
        glm::mat4 rotate = Maths::rotate(angle, glm::vec3(0.0f, 0.0f, 1.0f));

        //Changed here
        //glm::mat4 transformation = rotate; //Very cool, it works!
